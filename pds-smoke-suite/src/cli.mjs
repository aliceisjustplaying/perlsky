...
const usage = `Usage:
  pds-smoke-suite run-single [--adapter bring-your-own|perlsky] --config config.json
  pds-smoke-suite run-dual [--adapter bring-your-own|perlsky] --config config.json
  pds-smoke-suite validate --mode single|dual [--adapter bring-your-own|perlsky] --config config.json
  pds-smoke-suite print-example --mode single|dual [--adapter bring-your-own|perlsky]
